...
menu.bg.pre.Text = 'tracehook<font color="#00ff00">.wtf</font>'
local library = {cheatname = "";ext = "";gamename = "";colorpicking = false;tabbuttons = {};tabs = {};options = {};flags = {};scrolling = false;notifyText = Drawing.new("Text");playing = false;multiZindex = 200;toInvis = {};libColor = Color3.fromRGB(0, 255, 0);disabledcolor = Color3.fromRGB(233, 0, 0);blacklisted = {Enum.KeyCode.W,Enum.KeyCode.A,Enum.KeyCode.S,Enum.KeyCode.D,Enum.UserInputType.MouseMovement}}
    ...
    function tab:createGroup(pos,groupname) -- newTab[pos == 0 and "left" or "right"] 
        ...
        function group:addToggle(args)
            ...
            function toggle:addColorpicker(args)
                ...
                front.Name = "front"
                front.Parent = mid
                front.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                front.BorderColor3 = Color3.fromRGB(0, 0, 0)
                ...
                hue.Name = "hue"
                hue.Parent = main_2
                hue.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
...
local aimbotGroup = aimbotTab:createGroup('left', 'Create Configs')

aimbotGroup:addToggle({text = "aimbot",flag = "aimbot"})
aimbotGroup:addToggle({text = "show fov",flag = "showfov"})
